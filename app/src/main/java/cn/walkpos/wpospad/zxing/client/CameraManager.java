...
public final class CameraManager {
   ...
   */
  public void openDriver(SurfaceHolder holder, int titlebarHeight, boolean bPortrait) throws IOException {
  ...
  public Rect getFramingRect() {
    if (framingRect == null) {
      ...
      final int nSize = Math.min(screenResolution.x, screenResolution.y) * 3 / 4;
