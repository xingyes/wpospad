...
package cn.walkpos.wpospad.zxing.android.camera;
...
import cn.walkpos.wpospad.zxing.android.PlanarYUVLuminanceSource;
...
@SuppressLint("NewApi") public final class CameraManager {
	 ...
	 */
	public void openDriver(SurfaceHolder holder, boolean frontCamera) throws IOException {
        if (camera == null) {
            if(frontCamera)
            {
